...
import FooterYellow from '@/components/Footer/FooterYellow';
import {
  Alert,
  Image,
  SafeAreaView,
...
import HeaderYellow from '../../components/Header/HeaderYellow';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.questionSection}>
          <Text style={styles.questionTitle}>Zom Enigma</Text>
