    ...
    <View style={styles.crownContainer}>
      <View style={styles.crown}>
        ...
        <View style={styles.crownPeaks}>
          <View style={[styles.peak, styles.peak1]} />
          <View style={[styles.peak, styles.peak2]} />
          <View style={[styles.peak, styles.peak3]} />
          <View style={[styles.peak, styles.peak4]} />
          <View style={[styles.peak, styles.peak5]} />
        </View>
        {/* Crown base */}
        <View style={styles.crownBase} />
        {/* Crown jewels */}
        <View style={styles.jewel1} />
        <View style={styles.jewel2} />
        <View style={styles.jewel3} />
      </View>
    </View>
  );
